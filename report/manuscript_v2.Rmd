...
Lassa fever, caused by *Mammarenavirus lassaense* (LASV), is an endemic zoonosis in several West African countries. Human infections primarily result from transmission from rodent hosts, with *Mastomys natalensis*, a synanthropic species, serving as the principle reservoir. In Sierra Leone, small-mammal communities vary along land use gradients, and such ecological structuring may shape LASV transmission risk in human populations. However, the extent to which anthropogenic environments facilitate small-mammal interactions conducive to viral transmission remains poorly understood.

To address this, we conducted rodent sampling over 43,266 trap nights, detecting 684 rodents and shrews in the Lassa fever-endemic Eastern Province of Sierra Leone. To evaluate potential for within- and between-species transmission, we constructed space-sharing networks based on co-trapping within species-specific radii informed by home range estimates. These networks approximated shared space use rather than direct interaction, allowing us to compare potential encounter patterns across land use types. 

We found that small-mammal communities in agricultural settings had greater species richness and were more highly connected than those in villages and forests, although overall space-sharing rates did not differ substantially across habitats. Network topological structure varied by land use, with village networks exhibiting greater modularity than those in agricultural settings. Notably, space sharing among *M. natalensis* individuals was more frequent in agricultural settings than in villages, suggesting that land use may modulate opportunities for intra-specific viral transmission. 

LASV seroprevalence cross the small-mammal community was 5.7% with antibodies detected in nine species. We did not detect important differences in seroprevalence by land use type or network complexity. These findings underscore the importance of expanding rodent surveillance across various habitats to understand host ecology and viral transmission dynamics. Accounting for species-specific space use and habitat-dependent interaction structures will be crucial to identifying key hosts and environmental settings driving LASV persistence and spillover risk.


# Introduction

Lassa fever caused by *Mammarenavirus lassaense* (LASV) is a rodent-associated zoonoses endemic to West Africa, with an estimated 100,000-900,000 infections annually [@mccormick_prospective_1987; @basinski_bridging_2021]. Unlike the outbreaks in Nigeria, cases in other endemic countries - Guinea, Liberia and Sierra Leone - are sporadically documented [@jetoh_epidemiological_2022; @shaffer_space-time_2021; @bausch_lassa_2001]. In Sierra Leone disease outbreaks frequently go undetected, consistent with findings of up to 80% LASV seropositivity among human communities in regions previously not considered endemic [@grant_seroprevalence_2023]. Human infections typically result from transmission from rodent hosts, with limited subsequent human-to-human transmission [@lo_iacono_using_2015]. Understanding LASV transmission in endemic settings requires a detailed characterization of small-mammal community interactions, through which pathogen transmission occurs and is maintained.
...
The number of individuals (nodes) was highest in agricultural settings (n = 379) compared to villages (n = 261) and forests (n = 44). Networks in village settings exhibited the highest overall connectivity, as indicated by the highest mean degree (mean = 6.2, standard deviation (SD) = 4.6), followed by forests (mean = 5.1, SD = 3.3) and agricultural settings (mean = 4.9, SD = 5.4).  
