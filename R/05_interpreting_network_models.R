...
rodent_models_summary <- read_rds(here("data", "temp", "rodent_models_summary_2025-01-28.rds"))
rodent_network <- read_rds(here("data", "temp", "rodent_networks_2025-01-28.rds"))
rodent_data <- read_rds(here("data", "processed_data", "expanded_assemblages_2023-06-19.rds"))

final_model <- read_rds(here("data", "temp", "final_model_2025-01-28.rds"))
